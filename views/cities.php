<div class="wrap">
	...
	<table class="widefat wp-list-table">
		...
		?>
			<tr>
				<th scope="row" class="check-column"><label class="screen-reader-text" for="">Select City</label><input type="checkbox" name="ona_settlements[<?= $form_id ?>][]" value="<?= $city->_id ?>" id="checkbox_<?= $form_id ?>_<?= $city->_id ?>" <?= ((isset($data["ona_selected_cities"][$form_id]) && (in_array($city->_id, $data["ona_selected_cities"][$form_id])))) ? 'checked' :'' ?>></th>
